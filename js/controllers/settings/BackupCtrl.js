 ...
 *  }
 */
DuckieDocs.controller('BackupCtrl', ["$scope", "$rootScope", "$dialogs", "$filter", "FileReader", "SettingsService", "$q",
    function($scope, $rootScope, $dialogs, $filter, FileReader, SettingsService, $q) {
